...
{#if data.summary}
  ...
  <div class="space-y-4 mb-8">
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <!-- Track Package -->
      <a href="/track" class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl shadow-lg text-white block hover:shadow-xl transition-all active:scale-95 aspect-square p-5 flex flex-col justify-between">
        <div class="w-11 h-11 rounded-2xl bg-white/20 flex items-center justify-center">
